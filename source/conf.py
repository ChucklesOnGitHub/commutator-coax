...
html_logo = "_static/images/oe_logo_name.png" #i don't know why it stopped working with svg
...
html_context = {
    ...
    "github_repo": "commutator-coax", #change to commutators-docs
    "github_version": "main",
    "doc_path": "source",
